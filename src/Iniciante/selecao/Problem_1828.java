...
public class Problem_1828 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		for (int i = 1; i <= N; i++) {
			...
			else if (escolhas.equalsIgnoreCase("tesoura papel"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("papel pedra"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("pedra lagarto"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("lagarto spock"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("spock tesoura"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("tesoura lagarto"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("lagarto papel"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("papel spock"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("spock pedra"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else if (escolhas.equalsIgnoreCase("pedra tesoura"))
				System.out.println("Caso #" + i + ": Bazinga!");
			else
